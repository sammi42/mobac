 ...
 */
public class AmudananTrails extends AbstractHttpMapSource {

	public AmudananTrails() {
		super("AmudananTrails", 7, 15, TileImageType.PNG, TileUpdate.None);
	}

	@Override
	public String getTileUrl(int zoom, int x, int y) {
		return "http://amudanan.co.il/tiles/shvilimTrans_0907/Z" + zoom + "a/" + y + "/" + x + ".png";
	}
