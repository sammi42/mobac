...
public class RteType {
	...
	protected List<RteType.Rtept> rtept;
	 ...
	 * {@link Gpx10.Rte.Rtept }
	 * 
	 * 
	 */
	public List<RteType.Rtept> getRtept() {
		if (rtept == null) {
			rtept = new ArrayList<RteType.Rtept>();
		}
		return this.rtept;
	}
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "ele", "time", "magvar", "geoidheight", "name", "cmt",
			"desc", "src", "url", "urlname", "sym", "type", "fix", "sat", "hdop", "vdop", "pdop",
			"ageofdgpsdata", "dgpsid", "any" })
	public static class Rtept implements GpxPoint {
