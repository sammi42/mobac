...
import tac.mapsources.impl.MiscMapSources.Yandex;
...
public class MapSourcesManager {
	...
	static {
		...
		MAP_SOURCES = new MapSource[] { //
				...
				new Cykloatlas(), new Yandex(), new TerraserverUSA(), new UmpWawPl(),
				new DoCeluPL(), new EmapaPl(), new AustrianMap(), new FreemapSlovakia(),
				new FreemapSlovakiaHiking(), new FreemapSlovakiaHikingHillShade(),
				new Turaterkep(), new NearMap() };
	}
